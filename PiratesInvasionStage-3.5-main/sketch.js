...
function setup() {
  ...
  tower = new Tower(width / 2 - 500, height - 290, 250, 580);
...
function showboats(){
if (boats.length>0){
  if (boats.length<4 && boats[boats.length-1].body.position.x>300){
    var positions=[-90,-80,-70,-65]
  ...
  boat = new Boat(width, height -100, 200, 200,-60);
  boats.push(boat)
}
}
